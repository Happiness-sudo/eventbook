...
const S = {
  ...
  link: { color: "#FF3D9A", textDecoration: "none", fontWeight: 600 },
  ...
  info: { flex: 1 },
  category: { fontSize: "11px", fontWeight: 700, color: "#FF3D9A", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: "4px" },
